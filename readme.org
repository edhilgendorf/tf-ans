...
- GitHub to host code, configs, and static site: https://edhilgendorf.github.io/tf-ans/
- Terraform Cloud ( free ) to handle state and Terrafrom deployments upon check-in with GitHub
