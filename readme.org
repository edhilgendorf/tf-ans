...
#+end_src
* Verify your instance up to this point:
#+begin_src sh
ssh ec2-user@$(terraform output -json | jq  -r '."Jenkins-Main-Node-Public-IP"."value"') "grep "testing 1" /var/log/cloud-init-output.log"
#+end_src
