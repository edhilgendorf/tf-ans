...
*** Ansible for config management, hosted on
...
*** Jenkins to deploy the application [[#-create-infrastructure-with-terraform-ecs-for-awx-][ECS for AWX]]
