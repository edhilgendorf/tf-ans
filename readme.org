...
** Links
- [[https://github.com/edhilgendorf/tf-ans][Project GitHub]]
...
** [[./terraform/scripts/cloud-init.yaml]]
:PROPERTIES:
...
#+end_src
* Verify project up to this point
#+begin_src sh
ssh -o StrictHostKeyChecking=no ec2-user@$(terraform output -json | jq  -r '."Jenkins-Main-Node-Public-IP"."value"') "sudo grep 'testing 1' /var/log/cloud-init-output.log"
#+end_src
* Test terraform ignore readme files
